...
export default function About() {
    return (
        <section className="w-full h-auto p-4 relative after:content-[''] after:w-4/12 desktop:after:h-full mobile:after:h-2/6 after:block after:absolute after:top-0 after:left-0 after:bg-[#01D6A3] after:z-[1] ">
            <div className="w-full desktop:py-14 mobile:py-0 flex desktop:flex-row mobile:flex-col z-10 relative">
                <div className="desktop:w-3/6 mobile:w-full flex justify-center items-start">
