...
export default function Footer() {
    return (
        <section className="w-full h-auto desktop:mt-10 desktop:py-20 mobile:p-4 flex desktop:flex-row mobile:flex-col justify-center items-start bg-[#033b4a]" id="contact">
