...
export default function Hero() {
    return (
        <section>
            ...
            <div className="hero-container w-full h-screen" id="hero">
                <div className="max-w-[1200px] h-full m-auto flex flex-col justify-center z-50">
                    ...
                    <button className="hero-button desktop:w-[20%] desktop:mx-0 p-6 bg-[#01D6A3] text-white z-50 font-[500] transition-all hover:bg-[#033b4a] hover:text-[#01D6A3] hover:shadow-[10px_10px_1px_#01D6A3] mobile:mx-4">
