...
export default function Testimonial() {
    ...
    return (
        <section className="desktop:mt-28 mobile:mt-[10em] desktop:h-screen mobile:h-auto relative overflow-hidden after:content-[''] after:w-4/12 desktop:after:h-4/6 after:block after:absolute  after:bg-[#01D6A3] after:z-[-1] desktop:after:top-16 desktop:after:left-[80%] mobile:after:h-60 mobile:after:left-0 mobile:after:top-0">
