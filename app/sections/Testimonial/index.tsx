...
export default function Testimonial() {
    return (
        <section className="mt-28 desktop:h-screen mobile:h-auto relative overflow-hidden after:content-[''] after:w-4/12 desktop:after:h-4/6 after:block after:absolute after:top-16 after:-right-28 after:bg-[#01D6A3] after:z-[-1] mobile:after:h-60 mobile:after:left-0 mobile:after:top-0">
            <div className="max-w-7xl h-full mx-auto py-28 mobile:p-4 desktop:p-0 flex desktop:flex-row mobile:flex-col">
                <div className="desktop:w-3/6 mobile:w-full flex flex-col">
                    ...
                    <div className="w-full desktop:p-4 mobile:p-0 mt-10 flex desktop:flex-row mobile:flex-col gap-4">
                        <div className="desktop:w-3/6 mobile:w-full flex flex-col">
                            <p className="mb-auto desktop:text-sm mobile:text-md font-medium text-[#636B6E] mobile:text-pretty desktop:text-nowrap">Trabalhar com a G2L foi uma experiência incrível. Eles captaram exatamente o que nossa empresa precisava e transformaram nossa visão em um site dinâmico e intuitivo. O suporte contínuo e a atenção aos detalhes nos impressionaram muito. Recomendo sem hesitar!</p>
                        ...
                        <div className="desktop:w-3/6 mobile:w-full flex flex-col">
                            <p className="mb-auto desktop:text-sm mobile:text-md font-medium text-[#636B6E] mobile:text-pretty desktop:text-nowrap">A equipe da G2L superou todas as nossas expectativas! O aplicativo que desenvolveram para nossa marca trouxe mais engajamento e melhorou a experiência do usuário. Estamos muito felizes com os resultados e a parceria construída!</p>
                            <span className="mt-10">
                ...
                <div className="desktop:w-3/6 mobile:w-full relative mobile:order-[-1] after:content-[''] after:w-full desktop:after:h-[359px] mobile:after:h-[200px] after:block after:absolute after:top-0 after:bg-[#01D6A3] after:opacity-20">
