    ...
    return (
        <header className="w-full h-24 bg-white">
            <nav className="max-w-7xl h-full mx-auto flex items-center justify-center">
                ...
                <button className="mx-8 p-4 bg-[#01D6A3] text-white font-medium text-sm  transition-all hover:bg-[#033b4a] hover:text-[#01D6A3] hover:shadow-[10px_10px_1px_#01D6A3]">Entre em contato</button>
            </nav>
        </header>
    )
}